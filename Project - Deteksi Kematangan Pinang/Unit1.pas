...
var
  ...
  PinangMentah, PinangMatang, PinangTua: Integer;
...
begin
  ...
  begin
    ...
    if (Hue>=80) and (Hue<=100) and (Sat>=50) and (Sat<=100) and (Val>=30) and (Val<=70) then
    begin
      PinangMentah := PinangMentah + 1;
    end;

    if (Hue>=30) and (Hue<=70) and (Sat>=70) and (Sat<=100) and (Val>=60) and (Val<=100) then
    begin
      PinangMatang := PinangMatang + 1;
    end;

    if (Hue>=20) and (Hue<=40) and (Sat>=80) and (Sat<=100) and (Val>=60) and (Val<=100) then
    begin
      PinangTua := PinangTua + 1;
    end;
  end;
end;
...
begin
  ...
  maxVal := Max(Max(PinangMentah, PinangMatang), PinangTua);

  if maxVal = PinangMentah then
  LabelResult.Caption := 'Pinang Mentah';

  if maxVal = PinangMatang then
  LabelResult.Caption := 'Pinang Matang';

  if maxVal = PinangTua then
  LabelResult.Caption := 'Pinang Tua';
